  ...
  ${olflagTd}
    ...
    function updatePoleCorrRow() {
        ...
        _corrUniverse.forEach(function(pole, i) {
            ...
            // Interpolate bg: low corr -> light (#e2e8f0), high corr -> dark (#1e293b)
            // light rgb(226,232,240)  dark rgb(30,41,59)
            ...
            // Flip text color at midpoint for contrast
            const textColor = t >= 0.5 ? '#e2e8f0' : '#1e293b';
