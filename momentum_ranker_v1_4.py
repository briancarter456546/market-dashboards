...
def build_body_html(output, writer):
    ...
    table_html = (
        ...
        ' &nbsp;|&nbsp; <span style="color:#16a34a;font-weight:700;">&#9679;</span> clean'
        ' &nbsp;<span style="color:#d97706;font-weight:700;">&#9679;</span> stalling'
        ' &nbsp;<span style="color:#dc2626;font-weight:700;">&#9679;</span> overextended'
        ' &nbsp;|&nbsp; <span style="color:#2563eb;font-weight:700;">&#9679;</span> vol confirmed'
        ' &nbsp;<span style="color:#94a3b8;">&#9679;</span> vol normal'
        ' &nbsp;<span style="color:#cbd5e1;">&#9675;</span> vol thin'
        '</span></div>'
        + filter_html
