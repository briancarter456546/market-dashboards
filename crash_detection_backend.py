...
def build_body_html(output, writer):
    ...
    table_html = (
        ...
        '<thead><tr>'
        '<th title="RMT or Ising model component name">Component</th>'
        '<th title="Individual component score, 0=safe to 100=critical">Raw Score (0-100)</th>'
        '<th title="Relative weight of this component in composite score">Weight</th>'
        '<th title="Weighted contribution to final crash probability">Contribution</th>'
        '</tr></thead>'
        '<tbody>{rows}</tbody>'
        '</table>'
