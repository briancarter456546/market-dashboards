...
def build_section1_analogs(top_analogs):
    ...
    table = (
        ...
        '<thead>'
        '<tr>'
        '<th title="Match rank (1 = most similar to today)">#</th>'
        '<th title="End date of the matched historical period">End Date</th>'
        '<th>Year</th>'
        '<th>Period Label</th>'
        '<th title="Combined similarity score (momentum + spreads)">Composite</th>'
        '<th title="Momentum profile correlation with today">Momentum</th>'
        '<th title="Spread state similarity with today">Spreads</th>'
        '</tr>'
        '</thead>'
        '<tbody>'
        '{rows}'
...
def build_section2_outcomes(outcomes):
    ...
    for ticker in OUTCOME_DISPLAY_ORDER:
        ...
        card = (
            ...
            '<thead>'
            '<tr>'
            '<th title="Forward time period (5d, 10d, 21d)">Horizon</th>'
            '<th title="Average forward return across matched periods">Avg</th>'
            '<th title="Median forward return across matched periods">Median</th>'
            '<th title="20th percentile (pessimistic scenario)">P20</th>'
            '<th title="80th percentile (optimistic scenario)">P80</th>'
            '<th title="Win rate - percentage of matched periods with positive returns">%Pos</th>'
            '<th title="Number of historical matches in sample">N</th>'
            '</tr>'
            '</thead>'
            '<tbody>{rows}</tbody>'
            '</table>'
