...
v1.8: Rebuilt pullback signal as same-day entry timing alert
      - pullback_flag: 'buy_today' | 'none'
      - Fires when: ret_1d<0, sma_all, momentum=clean, ret_3m>0,
        score>=60 (post gate), vol_flag != confirmed (no distribution)
      - Removed RSI and SMA21 proximity (wrong frame for momentum stocks)
      - Removed fields: rsi_5, pct_from_sma21
