...
def _build_llm_prompt(output):
    ...
    lines.append('with similar momentum profiles to today (%s). Below are the top similar days from' % today_label)
    ...
    lines.append('- What macro conditions from these historical matches are most similar to NOW (%s)?' % today_label)
